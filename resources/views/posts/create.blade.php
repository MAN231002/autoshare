                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Create New Post</span>
                                    </div>
                                </div>
                                    ...
                                    <form action="/create" class="form-horizontal" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <textarea type="text" id="description" name="description" data-required="1" class="form-control" >{{ old('description') }}</textarea> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input name="brand" id="brand" value="{{ old('brand') }}"type="text" class="form-control" /> 
                                                </div>
                                            </div>
                                            <div class="form-group">
